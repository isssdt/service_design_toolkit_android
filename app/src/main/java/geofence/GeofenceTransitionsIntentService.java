...
//
//            Gson gson =new Gson();
//            String touch=geofence.getRequestId();
//
//            touchPointFieldResearcherDTO = gson.fromJson(touch, TouchPointFieldResearcherDTO.class);
//            triggeringGeofencesIdsList.add(touchPointFieldResearcherDTO.getTouchpointDTO().getTouchPointDesc());
//        }
...
//    }
    private String getGeofenceTransitionDetails(
        ...
        String triggeringGeofencesIdsString = TextUtils.join(", ",  triggeringGeofencesIdsList);
        sharedPref=getApplicationContext().getSharedPreferences("Trial", Context.MODE_PRIVATE);

        String list = sharedPref.getString("TouchPointFieldResearcherListDTO", "");
       touchPointFieldResearcherListDTO = gson.fromJson(list, TouchPointFieldResearcherListDTO.class);
        ...
        {
            if(touchPointFieldResearcherDTO.getTouchpointDTO().getTouchPointDesc().equals(triggeringGeofencesIdsList.get(0)))
            {
                touchPointFieldResearcherDTO1 = touchPointFieldResearcherDTO;
    ...
    private void sendNotification(String notificationDetails, int geofenceTransition) {
        ...
        if(geofenceTransition==Geofence.GEOFENCE_TRANSITION_ENTER) {
             notificationIntent = new Intent(getApplicationContext(), TouchPointDetailsActivity.class);

        }else
        {
           Log.d(TAG,"out of gepfence");
            notificationIntent = new Intent(getApplicationContext(), MainActivity.class);
        }

        notificationIntent.putExtra(TouchPointFieldResearcherDTO.class.toString(),touchPointFieldResearcherDTO1);
